...
def calculate_rewards(prompts, responses, reward_model, reward_tokenizer):
    """Combine all reward functions to compute total reward"""
    def reasoning_model_reward(rewards):
        # 1. （Only for reasoning model training）
        pattern = r"^<think>\n.*?\n</think>\n<answer>\n.*?\n</answer>$"
        pattern2 = r"^<think>\n.*?\n</think>\n\n<answer>\n.*?\n</answer>$"
        ...
        # 2. （Prevent sparse rewards，Only for reasoning model training）
        def mark_num(text):
            reward = 0
    ...
    # usereward modelCalculate entireresponsereward
    with torch.no_grad():
        reward_model_scores = []
        for prompt, response in zip(prompts, responses):
            ...
            # Whenargs.reasoning=1time，<answer>reward
            if args.reasoning == 1:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_weight', default='ppo_actor', type=str, help="Weight save prefix name")
    parser.add_argument("--epochs", type=int, default=1, help="Training epochs")
    parser.add_argument("--batch_size", type=int, default=2, help="batch size")
    parser.add_argument("--learning_rate", type=float, default=8e-8, help="ActorLearning rate")
    parser.add_argument("--critic_learning_rate", type=float, default=8e-8, help="CriticLearning rate")
    ...
    parser.add_argument('--max_seq_len', default=66, type=int, help="Prompt")
    parser.add_argument("--max_gen_len", type=int, default=1536, help="")
    parser.add_argument("--data_path", type=str, default="../dataset/rlaif-mini.jsonl", help="RLAIF")
    parser.add_argument("--clip_epsilon", type=float, default=0.1, help="PPO")
    parser.add_argument("--vf_coef", type=float, default=0.5, help="Value function")
    parser.add_argument("--kl_coef", type=float, default=0.02, help="KL")
    parser.add_argument("--reasoning", type=int, default=1, choices=[0, 1], help='（0=，1=）')
    parser.add_argument("--update_old_actor_freq", type=int, default=4, help="old_actor_model")
    parser.add_argument("--reward_model_path", type=str, default="../../internlm2-1_8b-reward", help="Reward")
    parser.add_argument('--from_resume', default=0, type=int, choices=[0, 1], help="yesno&（0=no，1=yes）")
    parser.add_argument("--use_wandb", action="store_true", help="yesnousewandb")
    parser.add_argument("--wandb_project", type=str, default="MiniMind-PPO", help="wandb")
    parser.add_argument("--use_compile", default=0, type=int, choices=[0, 1], help="yesnousetorch.compile（0=no，1=yes）")
