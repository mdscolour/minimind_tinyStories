...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_weight', default='pretrain', type=str, help="Weight save prefix name")
    parser.add_argument("--epochs", type=int, default=1, help="Training epochs（1轮zero或2-6）")
    ...
    parser.add_argument("--data_path", type=str, default="../dataset/pretrain_hq.jsonl", help="")
    parser.add_argument('--from_weight', default='none', type=str, help="，为none")
    ...
    parser.add_argument("--wandb_project", type=str, default="MiniMind-Pretrain", help="wandb")
