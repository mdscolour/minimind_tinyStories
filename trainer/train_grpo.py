...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_weight', default='grpo', type=str, help="Weight save prefix name")
    ...
    parser.add_argument("--num_generations", type=int, default=8, help="prompt")
    ...
    parser.add_argument("--wandb_project", type=str, default="MiniMind-GRPO", help="wandb")
