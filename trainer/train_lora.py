...
if __name__ == "__main__":
    ...
    parser.add_argument("--lora_name", type=str, default="lora_identity", help="LoRA(如lora_identity/lora_medical等)")
    ...
    parser.add_argument('--max_seq_len', default=340, type=int, help="（Chinese1token≈1.5~1.7chars）")
    parser.add_argument('--use_moe', default=0, type=int, choices=[0, 1], help="yesnoMoEarchitecture（0=no，1=yes）")
    parser.add_argument("--data_path", type=str, default="../dataset/lora_identity.jsonl", help="LoRA")
    parser.add_argument('--from_weight', default='full_sft', type=str, help="，full_sft")
    ...
    parser.add_argument("--wandb_project", type=str, default="MiniMind-LoRA", help="wandb")
    ...
    Logger(f"LLM : {total_params / 1e6:.3f} M")
    Logger(f"LoRA : {lora_params_count / 1e6:.3f} M")
    Logger(f"LoRA : {lora_params_count / total_params * 100:.2f}%")
