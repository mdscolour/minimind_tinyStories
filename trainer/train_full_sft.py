...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_weight', default='full_sft', type=str, help="Weight save prefix name")
    ...
    parser.add_argument('--from_weight', default='pretrain', type=str, help="，为none")
    ...
    parser.add_argument("--wandb_project", type=str, default="MiniMind-Full-SFT", help="wandb")
