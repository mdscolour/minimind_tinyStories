...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_weight', default='reason', type=str, help="Weight save prefix name")
    ...
    parser.add_argument('--max_seq_len', default=720, type=int, help="（Chinese1token≈1.5~1.7chars）")
    parser.add_argument('--use_moe', default=0, type=int, choices=[0, 1], help="yesnoMoEarchitecture（0=no，1=yes）")
    parser.add_argument("--data_path", type=str, default="../dataset/r1_mix_1024.jsonl", help="")
    parser.add_argument('--from_weight', default='dpo', type=str, help="，dpo")
    ...
    parser.add_argument("--wandb_project", type=str, default="MiniMind-Reasoning", help="wandb")
